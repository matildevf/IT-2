...
function navnet() {
  if (tilfeldig == 1) { //Om det tilfeldige tallet er 1 så...
    document.getElementById("dyrenavn").innerHTML = "Schwein"; //skal dyrenavnet gris vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Schaf"; //skal dyrenavnet sau vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Katze"; //skal dyrenavnet katt vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Hund"; //skal dyrenavnet hund vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Pferd"; //skal dyrenavnet hest vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Ziege"; //skal dyrenavnet geit vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Küken"; //skal dyrenavnet kylling vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Huhn"; //skal dyrenavnet høne vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Kaninchen"; //skal dyrenavnet kanin vises på skjermen
