...
function navnet() {
  if (tilfeldig == 1) { //Om det tilfeldige tallet er 1 så...
    document.getElementById("dyrenavn").innerHTML = "Monkey"; //skal dyrenavnet ape vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Elephant"; //skal dyrenavnet elefant vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Kengaroo"; //skal dyrenavnet kenguru vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Rhinoceros"; //skal dyrenavnet neshorn vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Hippo"; //skal dyrenavnet flodhest vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Snake"; //skal dyrenavnet slange vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Cheetah"; //skal dyrenavnet gepard vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Ostrich"; //skal dyrenavnet struts vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Penguin"; //skal dyrenavnet pingvin vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Vulture"; //skal dyrenavnet gribb vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Dromedary"; //skal dyrenavnet dromedar vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Anteater"; //skal dyrenavnet maursluker vises på skjermen
