...
function navnet() {
  if (tilfeldig == 1) { //Om det tilfeldige tallet er 1 så...
    document.getElementById("dyrenavn").innerHTML = "Singe"; //skal dyrenavnet ape vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Éléphant"; //skal dyrenavnet elefant vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Kangourou"; //skal dyrenavnet kenguru vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Rhinocéros"; //skal dyrenavnet neshorn vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Hippopotame"; //skal dyrenavnet flodhest vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Serpent"; //skal dyrenavnet slange vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Guépard"; //skal dyrenavnet gepard vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Toucan"; //skal dyrenavnet tukan vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Autruche"; //skal dyrenavnet struts vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Pingouin"; //skal dyrenavnet pingvin vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Vautour"; //skal dyrenavnet gribb vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Dromadaire"; //skal dyrenavnet dromedar vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Crocodile"; //skal dyrenavnet krokodille vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Lion"; //skal dyrenavnet løve vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Tamanoir"; //skal dyrenavnet maursluker vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Zèbre"; //skal dyrenavnet sebra vises på skjermen
