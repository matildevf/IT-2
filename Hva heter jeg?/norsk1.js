...
function navnet() {
  if (tilfeldig == 1) { //Om det tilfeldige tallet er 1 så...
    document.getElementById("dyrenavn").innerHTML = "Gris"; //skal dyrenavnet gris vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Sau"; //skal dyrenavnet sau vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Katt"; //skal dyrenavnet katt vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Hest"; //skal dyrenavnet hest vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Geit"; //skal dyrenavnet geit vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Kylling"; //skal dyrenavnet kylling vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Høne"; //skal dyrenavnet høne vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Kanin"; //skal dyrenavnet kanin vises på skjermen
