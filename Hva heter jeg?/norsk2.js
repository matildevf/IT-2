...
function navnet() {
  if (tilfeldig == 1) { //Om det tilfeldige tallet er 1 så...
    document.getElementById("dyrenavn").innerHTML = "Ape"; //skal dyrenavnet ape vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Kenguru"; //skal dyrenavnet kenguru vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Neshorn"; //skal dyrenavnet neshorn vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Flodhest"; //skal dyrenavnet flodhest vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Slange"; //skal dyrenavnet slange vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Struts"; //skal dyrenavnet struts vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Pingvin"; //skal dyrenavnet pingvin vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Gribb"; //skal dyrenavnet gribb vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Krokodille"; //skal dyrenavnet krokodille vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Løve"; //skal dyrenavnet løve vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Maursluker"; //skal dyrenavnet maursluker vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Sebra"; //skal dyrenavnet sebra vises på skjermen
