...
function navnet() {
  if (tilfeldig == 1) { //Om det tilfeldige tallet er 1 så...
    document.getElementById("dyrenavn").innerHTML = "Cerdo"; //skal dyrenavnet gris vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Oveja"; //skal dyrenavnet sau vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Gato"; //skal dyrenavnet katt vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Perro"; //skal dyrenavnet hund vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Caballo"; //skal dyrenavnet hest vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Cabra"; //skal dyrenavnet geit vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Pollo"; //skal dyrenavnet kylling vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Gallina"; //skal dyrenavnet høne vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Conejo"; //skal dyrenavnet kanin vises på skjermen
