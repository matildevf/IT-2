...
function navnet() {
  if (tilfeldig == 1) { //Om det tilfeldige tallet er 1 så...
    document.getElementById("dyrenavn").innerHTML = "Mono"; //skal dyrenavnet ape vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Elefante"; //skal dyrenavnet elefant vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Canguro"; //skal dyrenavnet kenguru vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Rinoceronte"; //skal dyrenavnet neshorn vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Hipopótamo"; //skal dyrenavnet flodhest vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Culebra"; //skal dyrenavnet slange vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Onza"; //skal dyrenavnet gepard vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Tukán"; //skal dyrenavnet tukan vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Avestruz"; //skal dyrenavnet struts vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Pingüino"; //skal dyrenavnet pingvin vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Buitre"; //skal dyrenavnet gribb vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Dromedario"; //skal dyrenavnet dromedar vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Cocodrilo"; //skal dyrenavnet krokodille vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "León"; //skal dyrenavnet løve vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Oso"; //skal dyrenavnet maursluker vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Cebra"; //skal dyrenavnet sebra vises på skjermen
