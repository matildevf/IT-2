...
function navnet() {
  if (tilfeldig == 1) { //Om det tilfeldige tallet er 1 så...
    document.getElementById("dyrenavn").innerHTML = "Cochon"; //skal dyrenavnet gris vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Mouton"; //skal dyrenavnet sau vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Chat"; //skal dyrenavnet katt vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Chien"; //skal dyrenavnet hund vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Cheval"; //skal dyrenavnet hest vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Chèvre"; //skal dyrenavnet geit vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Poulet"; //skal dyrenavnet kylling vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Poule"; //skal dyrenavnet høne vises på skjermen
    ...
    document.getElementById("dyrenavn").innerHTML = "Lapin"; //skal dyrenavnet kanin vises på skjermen
